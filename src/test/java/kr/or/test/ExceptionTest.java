package kr.or.test;
/**
 * 이 클래스는 자바앱에서 개발자 예외를 처리하는 방법 실습하는 클래스입니다.
 * @author 장연서
 *
 */
public class ExceptionTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("한꺼번에 출력하고 싶을 때 toString()메서드를 만듭니다.");
		...
		for(int cnt=0;cnt<=2;cnt++) {
			/**
			 * 개발자가 예외처리하는 기본형식 
			 * try {(필수)구현프로그램애서 에러가 발생하면}
			 * catch(에러발생기존정의된 상황) {(필수)에러발생시 처리할 구현내용}
			...
			try {
				...
				System.out.println(cnt + "번째 프로그램이 종료 되었습니다.");
			}
		}
